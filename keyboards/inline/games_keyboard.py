...
def understand_keyboard():
    ...
    button1 = InlineKeyboardButton(text="💢 Понятно", callback_data="game_jack_pot_main")
...
def game_menu_keyboard():
    ...
    button1 = InlineKeyboardButton(text="💰Джекпот💰", callback_data='game_jack_pot_main'
    )
    button2 = InlineKeyboardButton(text="🎴Баккара", callback_data='game_bakkara_main'
    )
    button3= InlineKeyboardButton(text="💣Мины💣", callback_data='mines_game_play'
    )
    button4 = InlineKeyboardButton(text="🃏21 очко🃏", callback_data='game_21_main'
    )
    button5 = InlineKeyboardButton(text="🎳🎯Игры🎲🏀", callback_data='game_other_main'
    )
    button6 = InlineKeyboardButton(text="🎰Слоты🎰 ", callback_data='game_slots_main')

    keyboard.add(button4)
    keyboard.add(button2, button6)
