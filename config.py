...
slots_photo = "https://i.imgur.com/UyyQ0Tu.jpg"
other_games_photo ="https://i.imgur.com/UyyQ0Tu.jpg"
blackjack_photo = "https://i.imgur.com/UyyQ0Tu.jpg"
bakkara_photo = "https://i.imgur.com/UyyQ0Tu.jpg"
jackpot_photo = "https://i.imgur.com/UyyQ0Tu.jpg"
...
def create_config():
    ...
    config.set("Settings", "game_percent", "8")
    config.set("Settings", "ref_percent", "8")
    config.set("Settings", "notification_chat", "-1001504493912")
    config.set("Settings", "support_username", "RobeFFM")
    config.set("Settings", "qiwi_address", "79528624279")
    config.set("Settings", "qiwi_token", "b60631a2065fc55a76ebef5a93291763")
